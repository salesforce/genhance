...
if is_torch_available():
    _import_structure["modeling_mt5"] = ["MT5EncoderModel", "MT5ForConditionalGeneration", "MT5ForConditionalGenerationWithLatentSpace", "MT5Model"]
...
if TYPE_CHECKING:
    ...
    if is_torch_available():
        from .modeling_mt5 import MT5EncoderModel, MT5ForConditionalGeneration, MT5ForConditionalGenerationWithLatentSpace, MT5Model
