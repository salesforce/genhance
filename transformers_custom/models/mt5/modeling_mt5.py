...
from ..t5.modeling_t5 import T5EncoderModel, T5ForConditionalGeneration, T5ForConditionalGenerationWithLatentSpace, T5Model
...
class MT5ForConditionalGenerationWithLatentSpace(T5ForConditionalGenerationWithLatentSpace):
    r"""
    This class overrides :class:`~transformers.T5ForConditionalGenerationWithLatentSpace`. Please check the superclass for the
