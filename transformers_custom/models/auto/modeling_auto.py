...
from ..mt5.modeling_mt5 import MT5ForConditionalGeneration, MT5ForConditionalGenerationWithLatentSpace, MT5Model
...
from ..t5.modeling_t5 import T5ForConditionalGeneration, T5ForConditionalGenerationWithLatentSpace, T5Discriminator, T5Model
...
MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (MT5Config, MT5ForConditionalGenerationWithLatentSpace),
        (T5Config, T5ForConditionalGeneration),
        (T5Config, T5ForConditionalGenerationWithLatentSpace),
        (T5Config, T5Discriminator),
