...
if is_torch_available():
    ...
    _import_structure["models.mt5"].extend(["MT5EncoderModel", "MT5ForConditionalGeneration", "MT5ForConditionalGenerationWithLatentSpace", "MT5Model"])
    ...
    _import_structure["models.t5"].extend(
        [
            ...
            "T5ForConditionalGenerationWithLatentSpace",
            "T5Discriminator",
            "T5Model",
            "T5PreTrainedModel",
...
if TYPE_CHECKING:
    ...
    if is_torch_available():
        ...
        from .models.mt5 import MT5EncoderModel, MT5ForConditionalGeneration, MT5ForConditionalGenerationWithLatentSpace, MT5Model
