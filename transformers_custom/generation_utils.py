    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            # sample
            # print("self.sample, model_kwargs.keys():", model_kwargs.keys())
            # print("self.sample, model_kwargs['encoder_outputs']: ", model_kwargs['encoder_outputs'])
            return self.sample(
                input_ids,
                logits_processor=logits_processor,
    ...
    def sample(
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            # forward pass to get next token
            # print("outputs = self(, model_inputs.keys(): ", model_inputs.keys())
            # print("outputs = self(, model_inputs['z_tar_edit_before_dec']: ", model_inputs['z_tar_edit_before_dec'])
            # print("outputs = self(, model_inputs['encoder_outputs']: ", model_inputs['encoder_outputs'])
            outputs = self(
                **model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
